...
class TestReferences(unittest.TestCase):
    ...
    def test_delete_all(self):
        ref.add_article(self.user_id, 'avain1', 'kirjoittaja', 'otsikko', 'julkaisu', 2010, 5)
        ref.add_book(self.user_id, 'avain2', 'kirjoittaja', 'otsikko', 'julkaisija', 2010)
        ref.add_inproceedings(self.user_id, 'avain3', 'kirjoittaja', 'otsikko', 'kirjaotsikko', 2010)
        ref.add_masterthesis(self.user_id, 'avain4', 'kirjoittaja', 'otsikko', 'koulu', 2010)
    ...
    def test_find_refkey_within_mastersthesis(self):
        ref.add_masterthesis(self.user_id, 'avain', 'kirjoittaja', 'otsikko', 'koulu', 2010)
        find = ref.find_refkey(self.user_id, 'avain')
    ...
    def test_get_bibtex_forms(self):
        ref.add_article(self.user_id, 'avain1', 'kirjoittaja1', 'otsikko1', 'julkaisu1', 2010, 5)
        ref.add_book(self.user_id, 'avain2', 'kirjoittaja2', 'otsikko2', 'julkaisija2', 2010)
        ref.add_inproceedings(self.user_id, 'avain3', 'kirjoittaja3', 'otsikko3', 'kirjaotsikko3', 2010)
        ref.add_masterthesis(self.user_id, 'avain4', 'kirjoittaja4', 'otsikko4', 'koulu4', 2010)
